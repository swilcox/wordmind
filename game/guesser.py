...
class Guesser:
    def __init__(self, game: Game, word_list: list[str], starting_word: str = "", search_cache: dict = None):
    ...
    def compute_guess(self) -> str:
        ...
        try:
            ...
            raise ex
        if self._use_cache:
            tmp_words = self.cache.get(regex, None) or list(filter(r.match, self.word_list))
